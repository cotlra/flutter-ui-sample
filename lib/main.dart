...
import 'package:ui_sample/page/animation/flip_card_page.dart';
  ...
  Widget build(BuildContext context) {
    final pageList = [
      PageInfo(
        ...
        category: PageCategory.rootNavigation,
      ),
      PageInfo(
      ...
      PageInfo(
        ...
        category: PageCategory.animation,
      ),
      PageInfo(
        pageName: 'カードの回転',
        pageRoute: '/flipCard',
    ...
    final routeMap = Map.fromIterables(
        pageList.map<String>((e) => e.pageRoute),
        pageList

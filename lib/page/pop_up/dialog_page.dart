              ...
              String? action = await showCupertinoModalPopup<String>(
                ...
                builder: (BuildContext context) {
                  return CupertinoActionSheet(
                    ...
                    actions: [
                      CupertinoActionSheetAction(onPressed: (){Navigator.pop<String>(context,'action1');}, child: const Text('アクション1')),
                      CupertinoActionSheetAction(onPressed: (){Navigator.pop<String>(context,'action2');}, child: const Text('アクション2')),
                      CupertinoActionSheetAction(onPressed: (){Navigator.pop<String>(context,'action3');}, child: const Text('アクション3')),
                    ],
                    cancelButton: CupertinoActionSheetAction(onPressed: (){Navigator.pop<String>(context,'cancel');}, child: const Text('キャンセル')),
                  );
                },
              );
            },
